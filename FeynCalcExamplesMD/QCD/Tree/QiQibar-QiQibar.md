...
```mathematica
description = 
     "Qi Qibar -> Qi Qibar, QCD, matrix element squared, tree"; 
...
![104k0e4fmsibf](img/104k0e4fmsibf.svg)
...
![0j9u0ewgcjd65](img/0j9u0ewgcjd65.svg)
...
![0uk7mnhxew924](img/0uk7mnhxew924.svg)
...
![1b4bnjgz117az](img/1b4bnjgz117az.svg)

```mathematica
ampSquaredMasslessSUNN3[0] = ampSquaredMassless[0] /. SUNN -> 3
```

![06kab1bgsp2tf](img/06kab1bgsp2tf.svg)

## Check the final results

```mathematica
knownResults = {(4/9)*SMP["g_s"]^4*((s^2 + u^2)/t^2 + 
              (t^2 + u^2)/s^2) - (8/27)*SMP["g_s"]^4*(u^2/(s*t))}; 
...
![0az6xkpktejgi](img/0az6xkpktejgi.svg)